...
<h2>서비스에서 만든 더미 데이터 10개를 컨트롤에서 화면에 탑재했고,</h2>
<h2>탑재된 데이터를 화면에 가져오기 연습</h2>
<h2>이 때, 사용하는 언어 EL 표기법을 이용하기.</h2>
<h2>컨트롤러에서 탑재시 사용했던 ("키":값), "키"로 이용하기</h2>
${list}
...
<h2>숫자 1~10 으로 반복문 이용해서 출력 (JSTL)</h2>
<ul>
